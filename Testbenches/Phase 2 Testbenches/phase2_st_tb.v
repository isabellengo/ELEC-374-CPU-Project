...
module phase2_st_tb;
    ...
    initial begin
        ...
        //Case 1
        //DUT.ram1.mem[0] = 32'h1300001F;
        
        //Case 2
        DUT.ram1.mem[0] = 32'h1330001F;

        // Pre-existing value at target address
        DUT.ram1.mem[9'h01F] = 32'h000000D4;
        DUT.ram1.mem[9'h082] = 32'h000000A7;

        // Preload R6 = 0x63 AFTER clear deasserts
    ...
    always @(*) begin
        ...
        case (Present_state)
            ...
            T6: begin
                Gra = 1; Rout = 1; MDRin = 1; // Read=0 so MDR <- BusMuxOut
            end
            T7: begin
                Write = 1;
            end
