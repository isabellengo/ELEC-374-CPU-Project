...
module phase2_jal_tb;
    ...
    initial begin
        ...
        // jal R4: Opcode(19) | Ra(4) | Rb(15) | C(0)
        // 5'b10011 | 4'b0100 | 4'b1111 | 19'h00000 ==> 0x9A780000
        // Ra=R4 is the jump target, Rb=R15 is the link register
        DUT.ram1.mem[0] = 32'h9A780000;
 
        #15 clear = 0; // Release reset

        // Preload R4 = 0xBB AFTER clear deasserts
        // Expected: R15 = PC_after_fetch(1), PC = R4 = 0xBB
        DUT.R4.q = 32'h000000BB;
    end
