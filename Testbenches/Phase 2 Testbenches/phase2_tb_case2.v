...
module phase2_tb_case2;
    ...
    initial begin
        ...
        DUT.ram1.mem[0] = 32'h80100072;
 
        // Preload R2 = 0x57
        // R2 + 0x72 = 0x57 + 0x72 = 0xC9
        DUT.R2.q = 32'h00000057;
 
        // mem[0xC9] = 0x2B
        DUT.ram1.mem[9'h0C9] = 32'h0000002B;
    end
    ...
    always @(*) begin
        ...
        case (Present_state)
            T0: begin
                ...
                #15 PCout = 0; MARin = 0; IncPC = 0; Zin = 0; // De-assert after use
            end
            T1: begin
